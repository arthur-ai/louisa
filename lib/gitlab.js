 ...
 *
 * Uses merged_at rather than updated_at so that Louisa's own post-merge enrichment
 * (which updates updated_at) does not pull MRs from prior releases into future
