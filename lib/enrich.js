...
Now produce the enriched title (line 1) and structured description. Follow the format exactly.`;
  ...
  const message = await activeSpan(tracer, "louisa.llm.enrich_pr_description", {
    "openinference.span.kind":              "LLM",
    "llm.model_name":                       "claude-opus-4-6",
    "llm.provider":                         "anthropic",
    "llm.invocation_parameters":            JSON.stringify({ model: "claude-opus-4-6", max_tokens: 2048 }),
    "llm.input_messages.0.message.role":    "system",
    "llm.input_messages.0.message.content": systemPrompt,
    "llm.input_messages.1.message.role":    "user",
    "llm.input_messages.1.message.content": userContent,
    "input.value":                          JSON.stringify({ platform, originalTitle }),
