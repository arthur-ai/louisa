...
export async function getPreviousReleaseTag(owner, repo, currentTag) {
  ...
  // Find the most recent release whose commit predates currentTag — this works
  // whether or not currentTag has a GitHub Release yet (e.g. on a tag-push event).
 ...
 *
 * Uses merged: date qualifier rather than updated: to avoid pulling PRs from prior
 * releases into future release note windows.
 *
